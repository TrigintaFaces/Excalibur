...
| `ci/f5-sweep.sh` | F-5 cross-project sibling-sweep pre-REVIEW gate: greps changed `src/**` type-contract tokens across all `tests/**` projects, lists un-triaged stale-sibling hits (`--self-test` for non-vacuity). |
