...
/// <summary>
/// Real-infrastructure conformance tests for <see cref="MongoDbPersistenceProvider"/> using the
/// Persistence Provider Conformance Test Kit against a live MongoDB container.
/// </summary>
/// <remarks>
...
/// <c>IOptions&lt;MongoDbProviderOptions&gt;</c> bound to the fixture's connection string, with
/// <c>UseSsl = false</c> because the test container does not present TLS.
/// </remarks>
...
public sealed class MongoDbPersistenceProviderConformanceShould : PersistenceProviderConformanceTestKit, IClassFixture<MongoDbContainerFixture>
{
	private readonly MongoDbContainerFixture _fixture;

	/// <summary>
	/// Initializes a new instance of the <see cref="MongoDbPersistenceProviderConformanceShould"/> class.
	/// </summary>
	/// <param name="fixture">The MongoDB container fixture.</param>
	public MongoDbPersistenceProviderConformanceShould(MongoDbContainerFixture fixture)
	{
		_fixture = fixture;
	}
	...
	protected override IPersistenceProvider CreateProvider(string providerName)
	{
		...
		var options = Options.Create(new MongoDbProviderOptions
		{
			Name = providerName,
			ConnectionString = _fixture.ConnectionString,
			DatabaseName = "persistence_conformance",
			UseSsl = false,
		});

		return new MongoDbPersistenceProvider(options, NullLogger<MongoDbPersistenceProvider>.Instance);
	}
