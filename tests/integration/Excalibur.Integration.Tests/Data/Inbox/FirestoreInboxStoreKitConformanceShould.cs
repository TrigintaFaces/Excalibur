...
/// <summary>
/// Binds <see cref="FirestoreInboxStore"/> to the SHIPPED <see cref="InboxStoreConformanceTestKit"/>
/// against a live Firestore emulator.
/// </summary>
...
[Trait("Pattern", "STORE")]
public sealed class FirestoreInboxStoreKitConformanceShould : InboxStoreConformanceTestKit, IAsyncLifetime
{
	private readonly FirestoreInboxStoreContainerFixture _fixture;
	private IInboxStore? _store;

	/// <summary>
	/// Initializes a new instance of the <see cref="FirestoreInboxStoreKitConformanceShould"/> class.
	/// </summary>
	/// <param name="fixture">The Firestore emulator fixture, shared by the collection.</param>
	public FirestoreInboxStoreKitConformanceShould(FirestoreInboxStoreContainerFixture fixture)
	{
		_fixture = fixture;
	}
	...
	protected override IInboxStore CreateStore()
	{
		...
		_store = new FirestoreInboxStore(
			_fixture.Db,
			options,
	...
	/// <inheritdoc/>
	/// <remarks>Deletes the collection's documents only; the store handle stays live for the arm.</remarks>
