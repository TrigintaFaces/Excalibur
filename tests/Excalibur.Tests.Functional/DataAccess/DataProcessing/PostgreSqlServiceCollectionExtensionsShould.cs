...
public class PostgreSqlServiceCollectionExtensionsShould : PostgreSqlPersistenceOnlyTestBase
{
	public PostgreSqlServiceCollectionExtensionsShould(PostgreSqlContainerFixture fixture, ITestOutputHelper output) : base(fixture, output)
	{
		ArgumentNullException.ThrowIfNull(fixture);
		using var connection = fixture.CreateDbConnection() as NpgsqlConnection;
		DataProcessingMother.EnsureDatabaseInitializedAsync(connection!, DatabaseEngine.PostgreSql).GetAwaiter().GetResult();
	}
