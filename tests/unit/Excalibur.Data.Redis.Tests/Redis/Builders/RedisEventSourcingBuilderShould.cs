...
/// <summary>
/// Unit tests for <see cref="RedisEventSourcingBuilder"/> — 4 connection overloads,
/// feature methods, last-wins semantics, and fluent chaining.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "Redis")]
public sealed class RedisEventSourcingBuilderShould : UnitTestBase
{
    private const string TestConnectionString = "localhost:6379";

    private static (RedisEventSourcingBuilder Builder, RedisEventStoreOptions Options) CreateBuilder()
    {
        var options = new RedisEventStoreOptions();
        var builder = new RedisEventSourcingBuilder(options);
    ...
    public void BindConfiguration_StorePath()
    {
        ...
        builder.BindConfiguration("EventSourcing:Redis");

        builder.BindConfigurationPath.ShouldBe("EventSourcing:Redis");
    }
    ...
    public void BindConfiguration_ClearOtherOverloads()
    {
        ...
        builder.ConnectionMultiplexer(multiplexer);
        builder.BindConfiguration("ES:Redis");

        options.ConnectionString.ShouldBe(null!);
        builder.MultiplexerInstance.ShouldBeNull();
        builder.MultiplexerFactoryFunc.ShouldBeNull();
        builder.BindConfigurationPath.ShouldBe("ES:Redis");
    }
    ...
    public void KeyPrefix_SetOnOptions()
    {
        ...
        options.StreamKeyPrefix.ShouldBe("myapp");
    }
    ...
    {
        var (builder, _) = CreateBuilder();
        var result = builder.BindConfiguration("ES:Redis");
        result.ShouldBeSameAs(builder);
    }
    ...
    public void Constructor_ThrowOnNullOptions()
    {
        Should.Throw<ArgumentNullException>(() =>
            new RedisEventSourcingBuilder(null!));
    }
    ...
    public void Compose_MultiplexerWithFeatures()
    {
        ...
        builder.MultiplexerInstance.ShouldBe(multiplexer);
        options.StreamKeyPrefix.ShouldBe("app");
