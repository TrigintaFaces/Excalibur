...
public sealed class UpdateDataTaskAttemptsShould
{
	[Fact]
	public void ThrowWhenConfigurationIsNull()
	{
		Should.Throw<ArgumentNullException>(
			() => new UpdateDataTaskAttempts(Guid.NewGuid(), 1, null!, 30, CancellationToken.None));
	}
	...
	public void HaveCommandWithUpdateSql()
	{
		...
		request.Command.CommandText.ShouldContain("Attempts");
	}
}
