...
namespace Excalibur.AuditLogging.Sentinel.Tests;

/// <summary>
/// Locks the Microsoft Sentinel audit exporter registration onto the typed client it configures.
...
public sealed class SentinelAuditRegistrationShould
{
...
#pragma warning disable IL2026, IL3050
		_ = services.AddSentinelAuditExporter(sentinel => sentinel.WorkspaceId("test-ws").SharedKey("dGVzdC1rZXk="));
