...
/// <summary>
/// Unit tests for <see cref="ElasticSearchOutboxBuilder"/> — 6 connection modes,
/// IndexName, last-wins semantics, fluent chaining, and validation guards.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "ElasticSearch")]
public sealed class ElasticSearchOutboxBuilderShould : UnitTestBase
{
    ...
    private static (ElasticSearchOutboxBuilder Builder, ElasticsearchOutboxOptions Options) CreateBuilder()
    {
        var options = new ElasticsearchOutboxOptions();
        var builder = new ElasticSearchOutboxBuilder(options);
    ...
    public void BindConfiguration_StorePathOnBuilder()
    {
        ...
        builder.BindConfiguration("ElasticSearch:Outbox");

        builder.BindConfigurationPath.ShouldBe("ElasticSearch:Outbox");
    }
    ...
    public void IndexName_SetValueOnOptions()
    {
        ...
        builder.IndexName("my-outbox");

        options.IndexName.ShouldBe("my-outbox");
    }
    ...
    {
        var (builder, _) = CreateBuilder();
        var result = builder.BindConfiguration("ElasticSearch:Outbox");
        result.ShouldBeSameAs(builder);
    }
    ...
    public void Constructor_ThrowOnNullOptions()
    {
        Should.Throw<ArgumentNullException>(() =>
            new ElasticSearchOutboxBuilder(null!));
    }
