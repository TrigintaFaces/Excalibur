// SPDX-FileCopyrightText: Copyright (c) 2026 The Excalibur Project// SPDX-License-Identifier: LicenseRef-Excalibur-1.0 OR AGPL-3.0-or-later OR SSPL-1.0 OR Apache-2.0
...
public sealed class EventStoreLiveSubscriptionDepthShould : IAsyncDisposable
{
	...
	public async Task UnsubscribeAsyncStopsPolling()
	{
		...
		await global::Tests.Shared.Infrastructure.TestTiming.PauseAsync(TimeSpan.FromMilliseconds(250), CancellationToken.None).ConfigureAwait(false);
