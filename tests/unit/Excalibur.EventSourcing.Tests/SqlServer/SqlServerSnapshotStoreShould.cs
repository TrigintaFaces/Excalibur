...
/// <summary>
/// Unit tests for the <see cref="SqlServerSnapshotStore"/> class.
/// </summary>
/// <remarks>
...
public sealed class SqlServerSnapshotStoreShould : UnitTestBase
{
	private readonly ILogger<SqlServerSnapshotStore> _logger = NullLoggerFactory.CreateLogger<SqlServerSnapshotStore>();
