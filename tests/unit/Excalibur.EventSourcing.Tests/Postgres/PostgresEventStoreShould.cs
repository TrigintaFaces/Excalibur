...
/// <summary>
/// Unit tests for the <see cref="PostgresEventStore"/> class.
/// </summary>
/// <remarks>
...
public sealed class PostgresEventStoreShould
{
	private readonly ILogger<PostgresEventStore> _logger = NullLoggerFactory.Instance.CreateLogger<PostgresEventStore>();
	...
	[Fact]
	public void SimpleConstructor_WithOptionalSerializers_CreatesInstance()
	{
		// Act
		var store = new PostgresEventStore(
			connectionString: "Host=localhost;Database=TestDb",
	...
	[Fact]
	public void AdvancedConstructor_WithOptionalSerializers_CreatesInstance()
	{
		// Arrange
		var dataSource = NpgsqlDataSource.Create("Host=localhost;Database=TestDb");
