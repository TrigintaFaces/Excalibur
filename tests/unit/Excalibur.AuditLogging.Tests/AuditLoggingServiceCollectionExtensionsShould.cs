...
public sealed class AuditLoggingServiceCollectionExtensionsShould
{
    ...
    public void Register_custom_audit_store_via_factory()
    {
        ...
        services.AddAuditLogging(_ => new InMemoryAuditStore(AuditIntegrityTestStrategy.Create(), TestTenantHosts.SingleTenantHost()));
    ...
    public void Return_service_collection_from_factory_add_audit_logging()
    {
        ...
        var result = services.AddAuditLogging(_ => new InMemoryAuditStore(AuditIntegrityTestStrategy.Create(), TestTenantHosts.SingleTenantHost()));
    ...
    public void Throw_argument_null_for_null_services_in_factory_add_audit_logging()
    {
        ...
        Should.Throw<ArgumentNullException>(() => services.AddAuditLogging(_ => new InMemoryAuditStore(AuditIntegrityTestStrategy.Create(), TestTenantHosts.SingleTenantHost())));
    }
