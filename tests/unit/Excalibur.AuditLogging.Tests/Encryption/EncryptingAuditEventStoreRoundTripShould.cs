...
using Excalibur.AuditLogging;namespace Excalibur.AuditLogging.Tests.Encryption;
...
{
    private readonly InMemoryAuditStore _innerStore = new(AuditIntegrityTestStrategy.Create(), TestTenantHosts.UntenantedAuditHost());
