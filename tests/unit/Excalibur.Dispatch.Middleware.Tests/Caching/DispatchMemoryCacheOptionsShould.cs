...
/// <summary>
/// Unit tests for DispatchMemoryCacheOptions POCO.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait("Component", "Dispatch.Core")]
public sealed class DispatchMemoryCacheOptionsShould : UnitTestBase
{
	[Fact]
	public void Create_WithDefaults_HasExpectedValues()
	{
		// Arrange & Act
		var config = new DispatchMemoryCacheOptions();
