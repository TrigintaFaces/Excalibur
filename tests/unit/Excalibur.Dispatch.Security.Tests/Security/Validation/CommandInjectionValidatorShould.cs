...
/// <summary>
/// Unit tests for <see cref="CommandInjectionValidator"/> internal class.
/// </summary>
[Trait("Category", "Unit")]
[Trait("Component", "Security")]
[Trait("Feature", "Validation")]
public sealed class CommandInjectionValidatorShould
{
	private readonly CommandInjectionValidator _sut;
	private readonly IDispatchMessage _message;
	private readonly IMessageContext _context;

	public CommandInjectionValidatorShould()
	{
		_sut = new CommandInjectionValidator();
	...
	{
		// Assert
		typeof(CommandInjectionValidator).IsNotPublic.ShouldBeTrue();
		typeof(CommandInjectionValidator).IsSealed.ShouldBeTrue();
	}
