...
/// <summary>
/// Unit tests for <see cref="MessageAgeValidator"/> internal class.
/// </summary>
[Trait("Category", "Unit")]
[Trait("Component", "Security")]
[Trait("Feature", "Validation")]
public sealed class MessageAgeValidatorShould
{
	private readonly MessageAgeValidator _sut;
	private readonly IDispatchMessage _message;
	private readonly IMessageContext _context;

	public MessageAgeValidatorShould()
	{
		_sut = new MessageAgeValidator();
	...
	{
		// Assert
		typeof(MessageAgeValidator).IsNotPublic.ShouldBeTrue();
		typeof(MessageAgeValidator).IsSealed.ShouldBeTrue();
	}
