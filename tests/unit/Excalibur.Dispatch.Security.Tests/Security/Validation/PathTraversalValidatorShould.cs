...
/// <summary>
/// Unit tests for <see cref="PathTraversalValidator"/> internal class.
/// </summary>
[Trait("Category", "Unit")]
[Trait("Component", "Security")]
[Trait("Feature", "Validation")]
public sealed class PathTraversalValidatorShould
{
	private readonly PathTraversalValidator _sut;
	private readonly IDispatchMessage _message;
	private readonly IMessageContext _context;

	public PathTraversalValidatorShould()
	{
		_sut = new PathTraversalValidator();
	...
	{
		// Assert
		typeof(PathTraversalValidator).IsNotPublic.ShouldBeTrue();
		typeof(PathTraversalValidator).IsSealed.ShouldBeTrue();
	}
