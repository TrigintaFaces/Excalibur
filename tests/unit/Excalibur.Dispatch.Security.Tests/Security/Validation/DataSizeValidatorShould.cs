...
/// <summary>
/// Unit tests for <see cref="DataSizeValidator"/> internal class.
/// </summary>
[Trait("Category", "Unit")]
[Trait("Component", "Security")]
[Trait("Feature", "Validation")]
public sealed class DataSizeValidatorShould
{
	private readonly DataSizeValidator _sut;
	private readonly IDispatchMessage _message;
	private readonly IMessageContext _context;

	public DataSizeValidatorShould()
	{
		_sut = new DataSizeValidator();
	...
	{
		// Assert
		typeof(DataSizeValidator).IsNotPublic.ShouldBeTrue();
		typeof(DataSizeValidator).IsSealed.ShouldBeTrue();
	}
