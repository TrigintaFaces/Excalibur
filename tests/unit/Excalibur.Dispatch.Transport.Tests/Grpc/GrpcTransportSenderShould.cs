...
public sealed class GrpcTransportSenderShould : IAsyncDisposable
{
	...
	public void ThrowWhenChannelIsNull()
	{
		Should.Throw<ArgumentNullException>(() =>
			new GrpcTransportSender((global::Grpc.Net.Client.GrpcChannel)null!, _options, NullLogger<GrpcTransportSender>.Instance));
	}
	...
	{
		Should.Throw<ArgumentNullException>(() =>
			new GrpcTransportSender((global::Grpc.Core.CallInvoker)null!, _options, NullLogger<GrpcTransportSender>.Instance));
	}
