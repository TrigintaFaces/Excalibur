...
/// last-successful-renewal timestamp on <see cref="RedisLeaderElection"/>).
/// </summary>
/// <remarks>
...
/// present); GREEN on the fix.
/// </remarks>
[Trait("Category", "Unit")]
[Trait("Component", "Core")]
public sealed class RedisLeaderElectionRenewalTicksShould
{
	[Fact]
	public void StoreLastSuccessfulRenewalAsAnInterlockedLongTicksField()
	{
		var ticksField = typeof(RedisLeaderElection)
	...
	{
		var legacyField = typeof(RedisLeaderElection)
