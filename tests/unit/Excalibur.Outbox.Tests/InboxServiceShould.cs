using Microsoft.Extensions.Logging.Abstractions;// SPDX-FileCopyrightText: Copyright (c) 2026 The Excalibur Project
...
public sealed class InboxServiceShould : UnitTestBase
{
	...
	public async Task EachServiceInstance_HasUniqueDispatcherId()
	{
		...
		await global::Tests.Shared.Infrastructure.WaitHelpers.AwaitSignalAsync(
			service1DispatchStarted.Task,
			global::Tests.Shared.Infrastructure.TestTimeouts.Scale(TimeSpan.FromSeconds(10)));
		await global::Tests.Shared.Infrastructure.WaitHelpers.AwaitSignalAsync(
			service2DispatchStarted.Task,
			global::Tests.Shared.Infrastructure.TestTimeouts.Scale(TimeSpan.FromSeconds(10)));
