...
/// <summary>
/// Unit tests for <see cref="BackgroundProcessorHealthChecksBuilderExtensions"/>.
...
public sealed class BackgroundProcessorHealthChecksExtensionsShould
{
	...
	public void ThrowArgumentNullException_WhenBuilderIsNull_ForOutbox()
	{
		...
		Should.Throw<ArgumentNullException>(() =>
			BackgroundProcessorHealthChecksBuilderExtensions.AddOutboxHealthCheck(null!));
	}
	...
	public void ThrowArgumentNullException_WhenBuilderIsNull_ForInbox()
	{
		// Act & Assert
		Should.Throw<ArgumentNullException>(() =>
			BackgroundProcessorHealthChecksBuilderExtensions.AddInboxHealthCheck(null!));
	}
