...
namespace Excalibur.AuditLogging.Splunk.Tests;

/// <summary>
/// Locks the Splunk HEC audit exporter registration onto the typed client it configures.
...
/// carrying none of the configuration AddHttpClient applied. Neither the resilience handler nor the primary handler that honours ValidateCertificate reached it.
/// The HttpClient timeout is the discriminator: the plain client's default is 100 seconds.
/// </summary>
[Trait("Category", "Unit")]
[Trait("Component", "Compliance")]
public sealed class SplunkAuditRegistrationShould
{
...
#pragma warning disable IL2026, IL3050
		_ = services.AddSplunkAuditExporter(splunk => splunk.HecEndpoint(new Uri("https://splunk.local:8088/services/collector")).HecToken("test-token"));
