...
/// <summary>
/// Unit tests for <see cref="MongoDBLeaderElectionBuilder"/> — 4 connection overloads,
/// feature methods, last-wins semantics, and fluent chaining.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "MongoDB")]
public sealed class MongoDBLeaderElectionBuilderShould : UnitTestBase
{
    private const string TestConnectionString = "mongodb://localhost:27017";

    private static (MongoDBLeaderElectionBuilder Builder, MongoDbLeaderElectionOptions Options) CreateBuilder()
    {
        var options = new MongoDbLeaderElectionOptions();
        var builder = new MongoDBLeaderElectionBuilder(options);
    ...
    public void BindConfiguration_StorePath()
    {
        ...
        builder.BindConfiguration("LeaderElection:MongoDB");

        builder.BindConfigurationPath.ShouldBe("LeaderElection:MongoDB");
    }
    ...
    public void BindConfiguration_ClearOtherOverloads()
    {
        ...
        builder.Client(client);
        builder.BindConfiguration("LE:MongoDB");

        options.ConnectionString.ShouldBe(null!);
        builder.ClientInstance.ShouldBeNull();
        builder.ClientFactoryFunc.ShouldBeNull();
        builder.BindConfigurationPath.ShouldBe("LE:MongoDB");
    }
    ...
    public void CollectionName_SetOnOptions()
    {
        ...
        builder.CollectionName("my_locks");

        options.CollectionName.ShouldBe("my_locks");
    }
    ...
    {
        var (builder, _) = CreateBuilder();
        var result = builder.BindConfiguration("LE:MongoDB");
        result.ShouldBeSameAs(builder);
    }
    ...
    public void Constructor_ThrowOnNullOptions()
    {
        Should.Throw<ArgumentNullException>(() =>
            new MongoDBLeaderElectionBuilder(null!));
    }
