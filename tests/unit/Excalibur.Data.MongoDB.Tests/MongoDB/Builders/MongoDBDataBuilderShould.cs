...
/// <summary>
/// Unit tests for <see cref="MongoDBDataBuilder"/> — 4 connection overloads,
/// DatabaseName feature method, last-wins semantics, and fluent chaining.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "MongoDB")]
public sealed class MongoDBDataBuilderShould : UnitTestBase
{
    private const string TestConnectionString = "mongodb://localhost:27017";

    private static (MongoDBDataBuilder Builder, MongoDbProviderOptions Options) CreateBuilder()
    {
        var options = new MongoDbProviderOptions();
        var builder = new MongoDBDataBuilder(options);
    ...
    public void BindConfiguration_StorePath()
    {
        ...
        builder.BindConfiguration("Data:MongoDB");

        builder.BindConfigurationPath.ShouldBe("Data:MongoDB");
    }
    ...
    {
        var (builder, _) = CreateBuilder();
        var result = builder.BindConfiguration("Data:MongoDB");
        result.ShouldBeSameAs(builder);
    }
