...
/// <summary>
/// Unit tests for <see cref="MongoDBInboxBuilder"/> — 4 connection overloads,
/// feature methods, last-wins semantics, and fluent chaining.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "MongoDB")]
public sealed class MongoDBInboxBuilderShould : UnitTestBase
{
    private const string TestConnectionString = "mongodb://localhost:27017";

    private static (MongoDBInboxBuilder Builder, MongoDbInboxOptions Options) CreateBuilder()
    {
        var options = new MongoDbInboxOptions();
        var builder = new MongoDBInboxBuilder(options);
    ...
    public void BindConfiguration_StorePath()
    {
        ...
        builder.BindConfiguration("Inbox:MongoDB");

        builder.BindConfigurationPath.ShouldBe("Inbox:MongoDB");
    }
    ...
    public void CollectionName_SetOnOptions()
    {
        ...
        builder.CollectionName("my_inbox");

        options.CollectionName.ShouldBe("my_inbox");
    }
    ...
    {
        var (builder, _) = CreateBuilder();
        var result = builder.BindConfiguration("Inbox:MongoDB");
        result.ShouldBeSameAs(builder);
    }
