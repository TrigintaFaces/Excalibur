...
/// <summary>
/// Unit tests for <see cref="SagaBuilderDynamoDbExtensions.UseDynamoDb(ISagaBuilder, Action{IDynamoDBSagaBuilder})"/>.
/// Validates null guards, fluent chaining, configure invocation, and options registration
/// for the <c>Action&lt;IDynamoDBSagaBuilder&gt;</c> entry point.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "DynamoDB")]
public sealed class SagaBuilderDynamoDbExtensionsShould : UnitTestBase
{
    ...
    [Fact]
    public void UseDynamoDb_RegisterSagaOptions()
    {
        // Arrange
        var services = new ServiceCollection();
        var builder = A.Fake<ISagaBuilder>();
    ...
    public void UseDynamoDb_ConfiguresTableNameViaBuilder()
    {
        ...
        options.Value.TableName.ShouldBe("my_sagas");
    }
}
