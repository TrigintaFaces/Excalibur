...
/// <summary>
/// Unit tests for <see cref="DynamoDBInboxBuilder"/> — 5 connection overloads,
...
public sealed class DynamoDBInboxBuilderShould : UnitTestBase
{
    private static DynamoDBInboxBuilder CreateBuilder() => new();
    ...
    {
        var builder = CreateBuilder();
        builder.BindConfiguration("Inbox:DynamoDB");
        builder.BindConfigurationPath.ShouldBe("Inbox:DynamoDB");
    }
    ...
    {
        var builder = CreateBuilder();
        builder.TableName("inbox-messages");
        builder.TableNameValue.ShouldBe("inbox-messages");
    }
    ...
    {
        var builder = CreateBuilder();
        builder.TablePrefix("test-");
        builder.TablePrefixValue.ShouldBe("test-");
    }
    ...
    public void Region_ClearAllOtherConnectionOverloads()
    {
        ...
        builder.Region(RegionEndpoint.EUCentral1);
