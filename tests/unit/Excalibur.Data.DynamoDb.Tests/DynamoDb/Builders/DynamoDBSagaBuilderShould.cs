...
/// <summary>
/// Unit tests for <see cref="DynamoDBSagaBuilder"/> — 5 connection overloads,
...
public sealed class DynamoDBSagaBuilderShould : UnitTestBase
{
    private static DynamoDBSagaBuilder CreateBuilder() => new();
    ...
    {
        var builder = CreateBuilder();
        builder.BindConfiguration("Saga:DynamoDB");
        builder.BindConfigurationPath.ShouldBe("Saga:DynamoDB");
    }
    ...
    {
        var builder = CreateBuilder();
        builder.TableName("sagas");
        builder.TableNameValue.ShouldBe("sagas");
    }
    ...
    {
        var builder = CreateBuilder();
        builder.TablePrefix("staging-");
        builder.TablePrefixValue.ShouldBe("staging-");
    }
    ...
    public void Region_ClearAllOtherConnectionOverloads()
    {
        ...
        builder.Region(RegionEndpoint.APSoutheast1);
