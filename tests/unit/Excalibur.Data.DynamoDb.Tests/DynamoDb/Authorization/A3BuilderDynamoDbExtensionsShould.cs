...
/// <summary>
/// Unit tests for <see cref="A3BuilderDynamoDbExtensions"/>.
/// </summary>
[Trait("Category", TestCategories.Unit)]
[Trait("Component", "A3")]
[Trait("Feature", "DependencyInjection")]
public sealed class A3BuilderDynamoDbExtensionsShould
{
	[Fact]
	...
	[Fact]
	public void RegisterIGrantStore_AsDynamoDbGrantStore()
	{
		// Arrange
		var services = new ServiceCollection();
	...
	[Fact]
	public void RegisterIActivityGroupGrantStore_AsDynamoDbActivityGroupGrantStore()
	{
		// Arrange
		var services = new ServiceCollection();
