...
public sealed class ErasureTelemetryConstantsShould
{
	...
	{
		ErasureTelemetryConstants.MeterName.ShouldBe("Excalibur.Compliance.Erasure");
	}

	[Fact]
	public void Have_correct_activity_source_name()
	{
		ErasureTelemetryConstants.ActivitySourceName.ShouldBe("Excalibur.Compliance.Erasure");
	}
