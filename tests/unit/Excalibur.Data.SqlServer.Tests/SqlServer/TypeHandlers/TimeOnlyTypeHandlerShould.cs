...
/// <summary>
/// Unit tests for <see cref="TimeOnlyTypeHandler"/>.
/// </summary>
[Trait("Category", "Unit")]
[Trait("Component", "TypeHandlers")]
public sealed class TimeOnlyTypeHandlerShould : UnitTestBase
{
	private readonly TimeOnlyTypeHandler _sut = new();
	...
	{
		// Arrange
		var handler = new TimeOnlyTypeHandler(CultureInfo.InvariantCulture);
	...
	[Fact]
	public void SetValue_SetDbTypeTimeAndValue_WhenCalledWithTimeOnly()
	{
		// Arrange
	...
	{
		// Arrange
		var handler = new TimeOnlyTypeHandler(CultureInfo.GetCultureInfo("de-DE"));
