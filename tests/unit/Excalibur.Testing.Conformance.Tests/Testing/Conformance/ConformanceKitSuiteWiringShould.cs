...
public sealed class ConformanceKitSuiteWiringShould
{
	...
	private sealed class FullyWiredLegalHoldStoreProbe : LegalHoldStoreConformanceTestKit
	{
		...
		public Task GetActiveHoldsForDataSubjectAsync_EmptyTenantId_ShouldBehaveAsUnspecified_Test() => GetActiveHoldsForDataSubjectAsync_EmptyTenantId_ShouldBehaveAsUnspecified();
	...
	private sealed class FullyWiredDataInventoryStoreProbe : DataInventoryStoreConformanceTestKit
	{
		...
		public Task GetDataMapEntriesAsync_ShouldNotFabricateRecordCountForDiscoveredOnlyEntries_Test() => GetDataMapEntriesAsync_ShouldNotFabricateRecordCountForDiscoveredOnlyEntries();
		public Task SaveRegistrationAsync_ShouldAcceptNamesAtTheDeclaredColumnWidths_Test() => SaveRegistrationAsync_ShouldAcceptNamesAtTheDeclaredColumnWidths();
