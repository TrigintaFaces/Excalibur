...
/// <summary>
/// Confirms <see cref="PostgresHealthBasedLeaderElectionOptionsValidator"/> actually fires (rl25og): the validator
...
public sealed class PostgresHealthBasedLeaderElectionOptionsValidatorShould
{
	private static readonly PostgresHealthBasedLeaderElectionOptionsValidator Validator = new();

	private static PostgresHealthBasedLeaderElectionOptions Valid() => new()
	{
		SchemaName = "public",
		TableName = "leader_election_health",
