...
/// <summary>
/// Unit tests for <see cref="PostgresInboxBuilder"/> argument validation guards.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "Postgres")]
public sealed class PostgresInboxBuilderValidationShould : UnitTestBase
{
    private static PostgresInboxBuilder CreateBuilder() =>
        new(new PostgresInboxOptions());
    ...
    // --- MaxRetryCount guards ---

    [Fact]
    public void MaxRetryCount_ThrowOnNegativeValue()
    {
        var builder = CreateBuilder();
        Should.Throw<ArgumentOutOfRangeException>(() => builder.MaxRetryCount(-1));
    }
}
