...
/// <summary>
/// Unit tests for <see cref="PostgresLeaderElectionBuilder"/> — 5 connection overloads,
/// LockKey feature, last-wins semantics, and fluent chaining.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "Postgres")]
public sealed class PostgresLeaderElectionBuilderShould : UnitTestBase
{
    private const string TestConnectionString =
        "Host=localhost;Database=TestDb;Username=test;Password=test";

    private static (PostgresLeaderElectionBuilder Builder, PostgresLeaderElectionOptions Options) CreateBuilder()
    {
        var options = new PostgresLeaderElectionOptions();
        var builder = new PostgresLeaderElectionBuilder(options);
    ...
    public void ConnectionStringName_StoreName()
    {
        ...
        builder.ConnectionStringName("LeaderElection");
    ...
    [Fact]
    public void LockKey_SetValueOnOptions()
    {
        var (builder, options) = CreateBuilder();
        builder.LockKey(42);
    ...
    [Fact]
    public void LockKey_AcceptLargeValues()
    {
        var (builder, options) = CreateBuilder();
        builder.LockKey(long.MaxValue);
        options.LockKey.ShouldBe(long.MaxValue);
    }
    ...
    public void Constructor_ThrowOnNullOptions()
    {
        Should.Throw<ArgumentNullException>(() =>
            new PostgresLeaderElectionBuilder(null!));
    }
}
