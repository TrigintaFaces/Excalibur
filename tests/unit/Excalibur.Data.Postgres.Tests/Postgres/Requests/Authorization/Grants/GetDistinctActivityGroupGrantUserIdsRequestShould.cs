...
/// <summary>
/// Unit tests for <see cref="GetDistinctActivityGroupGrantUserIdsRequest"/>.
/// Covers SQL structure, parameter setup, and command timeout.
/// </summary>
[Trait("Category", "Unit")]
[Trait("Component", "Postgres")]
public sealed class GetDistinctActivityGroupGrantUserIdsRequestShould
{
	...
	{
		// Act
		var request = new GetDistinctActivityGroupGrantUserIdsRequest(
		...
		request.RequestType.ShouldBe(nameof(GetDistinctActivityGroupGrantUserIdsRequest));
	}

	[Fact]
	public void GenerateSql_WithSelectDistinct()
	{
		// Act
		var request = new GetDistinctActivityGroupGrantUserIdsRequest(
			GrantType, CancellationToken.None);
		...
		sql.ShouldContain("SELECT DISTINCT user_id");
	}
