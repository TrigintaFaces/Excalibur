...
namespace Excalibur.Dispatch.Tests.ConnectionPooling;

/// <summary>
/// Unit tests for <see cref="ConnectionOptions{TConnection}"/>.
/// </summary>
[Trait("Category", "Unit")]
[Trait("Component", "ConnectionPooling")]
[Trait("Priority", "0")]
public sealed class ConnectionOptionsShould
{
	...
	{
		// Arrange & Act
		var config = new ConnectionOptions<TestConnection>();
