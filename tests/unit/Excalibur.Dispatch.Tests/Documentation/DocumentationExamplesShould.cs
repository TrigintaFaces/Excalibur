...
public sealed class DocumentationExamplesShould
{
	...
	public void Compile_MessageResultSuccessExamples()
	{
		...
		result3.Disposition.ShouldBe(MessageDisposition.ServedFromCache);
	}
	...
	public void Compile_MessageResultCheckingExamples()
	{
		...
		if (result.Disposition == MessageDisposition.ServedFromCache)
		{
	...
	public async Task Compile_MapAsyncExtensionExamples()
	{
		...
		{
			await global::Tests.Shared.Infrastructure.TestTiming.PauseAsync(1); // Simulate async work
	...
	public async Task Compile_BindAsyncExtensionExamples()
	{
		...
		{
			await global::Tests.Shared.Infrastructure.TestTiming.PauseAsync(1); // Simulate async check
