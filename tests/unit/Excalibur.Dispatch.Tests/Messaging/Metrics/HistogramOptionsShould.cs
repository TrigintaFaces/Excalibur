...
public sealed class HistogramOptionsShould
{
	[Fact]
	public void CreateWithBuckets()
	{
		var config = new HistogramOptions(1.0, 5.0, 10.0);
	...
	{
		var config = new HistogramOptions(10.0, 1.0, 5.0);
	...
	{
		Should.Throw<ArgumentException>(() => new HistogramOptions(null!));
	}

	[Fact]
	public void ThrowOnEmptyBuckets()
	{
		Should.Throw<ArgumentException>(() => new HistogramOptions([]));
	}
	...
	{
		Should.Throw<ArgumentException>(() => HistogramOptions.Exponential(0, 2, 5));
	}

	[Fact]
	public void Exponential_ThrowOnNegativeStart()
	{
		Should.Throw<ArgumentException>(() => HistogramOptions.Exponential(-1, 2, 5));
	}

	[Fact]
	public void Exponential_ThrowOnFactorLessThanOrEqualToOne()
	{
		Should.Throw<ArgumentException>(() => HistogramOptions.Exponential(100, 1, 5));
		Should.Throw<ArgumentException>(() => HistogramOptions.Exponential(100, 0.5, 5));
	}

	[Fact]
	public void Exponential_ThrowOnZeroCount()
	{
		Should.Throw<ArgumentException>(() => HistogramOptions.Exponential(100, 2, 0));
	}

	[Fact]
	public void CreateLinearBuckets()
	{
		var config = HistogramOptions.Linear(10, 5, 4);
	...
	{
		Should.Throw<ArgumentException>(() => HistogramOptions.Linear(10, 0, 5));
	}

	[Fact]
	public void Linear_ThrowOnNegativeWidth()
	{
		Should.Throw<ArgumentException>(() => HistogramOptions.Linear(10, -1, 5));
	}

	[Fact]
	public void Linear_ThrowOnZeroCount()
	{
		Should.Throw<ArgumentException>(() => HistogramOptions.Linear(10, 5, 0));
	}
}
