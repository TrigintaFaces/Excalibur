...
public sealed class PerformanceRecordsShould
{
	...
	public void CacheFreezeStatus_AllFrozen()
	{
		...
		var status = new CacheFreezeStatus(true, true, true, true, frozenAt);
	...
	{
		var status = new CacheFreezeStatus(true, true, false, true, null);
	...
	{
		var s1 = new CacheFreezeStatus(true, true, true, true, null);
		var s2 = new CacheFreezeStatus(true, true, true, true, null);
