...
public sealed class ElasticsearchAuditExporterDepthShould : IDisposable
{
	...
	public void JsonContext_GetTypeInfo_ReturnsKnownTypes()
	{
		...
		var contextType = assembly.GetType("Excalibur.AuditLogging.Elasticsearch.ElasticsearchAuditJsonContext", throwOnError: true)!;
		...
		var payloadType = assembly.GetType("Excalibur.AuditLogging.Elasticsearch.ElasticsearchAuditExporter+ElasticsearchAuditPayload", throwOnError: true)!;
		var metaType = assembly.GetType("Excalibur.AuditLogging.Elasticsearch.ElasticsearchAuditExporter+BulkActionMeta", throwOnError: true)!;
		var indexType = assembly.GetType("Excalibur.AuditLogging.Elasticsearch.ElasticsearchAuditExporter+BulkIndexAction", throwOnError: true)!;
	...
	public void JsonContext_CanRoundTripBulkIndexAndPayloadAcrossNullabilityVariants()
	{
		...
		var payloadType = assembly.GetType(
			"Excalibur.AuditLogging.Elasticsearch.ElasticsearchAuditExporter+ElasticsearchAuditPayload",
			throwOnError: true)!;
		var bulkMetaType = assembly.GetType(
			"Excalibur.AuditLogging.Elasticsearch.ElasticsearchAuditExporter+BulkActionMeta",
			throwOnError: true)!;
		var bulkIndexType = assembly.GetType(
			"Excalibur.AuditLogging.Elasticsearch.ElasticsearchAuditExporter+BulkIndexAction",
			throwOnError: true)!;
	...
	private static JsonSerializerContext CreateJsonContext()
	{
		var contextType = typeof(ElasticsearchAuditExporter).Assembly.GetType(
			"Excalibur.AuditLogging.Elasticsearch.ElasticsearchAuditJsonContext",
			throwOnError: true)!;
