...
/// <summary>
/// Locks the Elasticsearch audit registrations onto the typed clients they configure.
...
public sealed class ElasticsearchAuditRegistrationShould
{
	...
	public void GiveTheExporterTheConfiguredTypedClient()
	{
		...
		_ = services.AddElasticsearchAuditExporter(es => es
