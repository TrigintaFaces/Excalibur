...
/// <summary>
/// Unit tests for <see cref="FirestoreSagaBuilder"/> — 8 connection/config methods,
/// Firestore-specific last-wins semantics, fluent chaining, and validation guards.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "Firestore")]
public sealed class FirestoreSagaBuilderShould : UnitTestBase
{
    private static (FirestoreSagaBuilder Builder, FirestoreSagaOptions Options) CreateBuilder()
    {
        var options = new FirestoreSagaOptions();
        var builder = new FirestoreSagaBuilder(options);
    ...
    public void BindConfiguration_StorePathOnBuilder()
    {
        ...
        builder.BindConfiguration("Firestore:Saga");

        builder.BindConfigurationPath.ShouldBe("Firestore:Saga");
    }
    ...
    public void CollectionName_SetValueOnOptions()
    {
        ...
        builder.CollectionName("my-sagas");

        builder.CollectionNameValue.ShouldBe("my-sagas");
        options.CollectionName.ShouldBe("my-sagas");
    }
    ...
    {
        var (builder, _) = CreateBuilder();
        var result = builder.BindConfiguration("Firestore:Saga");
        result.ShouldBeSameAs(builder);
    }
