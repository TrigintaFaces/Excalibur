...
/// <summary>
/// Unit tests for <see cref="FirestoreOutboxBuilder"/> — 8 connection/config methods,
/// Firestore-specific last-wins semantics, fluent chaining, and validation guards.
/// </summary>
[Trait(TraitNames.Category, TestCategories.Unit)]
[Trait(TraitNames.Component, TestComponents.Core)]
[Trait("Database", "Firestore")]
public sealed class FirestoreOutboxBuilderShould : UnitTestBase
{
    private static (FirestoreOutboxBuilder Builder, FirestoreOutboxOptions Options) CreateBuilder()
    {
        var options = new FirestoreOutboxOptions();
        var builder = new FirestoreOutboxBuilder(options);
    ...
    public void Constructor_ThrowOnNullOptions()
    {
        Should.Throw<ArgumentNullException>(() =>
            new FirestoreOutboxBuilder(null!));
    }
    ...
    public void BindConfiguration_StorePathOnBuilder()
    {
        ...
        builder.BindConfiguration("Firestore:Outbox");

        builder.BindConfigurationPath.ShouldBe("Firestore:Outbox");
    }
    ...
    public void CollectionName_SetValueOnOptions()
    {
        ...
        builder.CollectionName("my-outbox");

        builder.CollectionNameValue.ShouldBe("my-outbox");
        options.CollectionName.ShouldBe("my-outbox");
    }
    ...
    {
        var (builder, _) = CreateBuilder();
        var result = builder.BindConfiguration("Firestore:Outbox");
        result.ShouldBeSameAs(builder);
    }
