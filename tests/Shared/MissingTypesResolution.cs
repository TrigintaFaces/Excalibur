...
// - Excalibur License 1.1 (see LICENSE-EXCALIBUR.txt)
...
/// <summary>
///     Placeholder used to resolve linked source includes during the build.
/// </summary>
internal static class MissingTypesResolution
{
}
