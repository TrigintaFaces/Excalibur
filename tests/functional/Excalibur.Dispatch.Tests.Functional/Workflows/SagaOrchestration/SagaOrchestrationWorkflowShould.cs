...
namespace Excalibur.Dispatch.Tests.Functional.Workflows.SagaOrchestration;

/// <summary>
/// End-to-end functional tests for saga orchestration workflows.
...
public sealed class SagaOrchestrationWorkflowShould : FunctionalTestBase
{
	/// <summary>
	...
	public sealed class OrderFulfillmentData
	{
	...
	public sealed class InMemorySagaStore
	{
	...
	public sealed class OrderFulfillmentSaga
	{
		...
		public async Task ProcessStepAsync(string sagaId, SagaStep step)
		{
			...
			{
				await Task.Delay(StepTimeout + TimeSpan.FromMilliseconds(50)).ConfigureAwait(false);
