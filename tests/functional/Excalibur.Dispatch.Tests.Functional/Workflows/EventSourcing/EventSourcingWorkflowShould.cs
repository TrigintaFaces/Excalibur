...
namespace Excalibur.Dispatch.Tests.Functional.Workflows.EventSourcing;

/// <summary>
/// End-to-end functional tests for event sourcing workflows.
...
public sealed class EventSourcingWorkflowShould : FunctionalTestBase
{
	/// <summary>
	...
	public sealed record OrderCreated(string AggregateId, string OrderId, string CustomerId) : IDomainEvent;
	public sealed record ItemAdded(string AggregateId, string ProductId, int Quantity, decimal Price) : IDomainEvent;
	public sealed record OrderSubmitted(string AggregateId) : IDomainEvent;

	// Event versions for upcasting test
	public sealed record ProductPriceChangedV1(string AggregateId, string ProductId, decimal NewPrice) : IDomainEvent;
	public sealed record ProductPriceChangedV2(string AggregateId, string ProductId, decimal NewPrice, string Currency) : IDomainEvent;
	public sealed record ProductPriceChangedV3(string AggregateId, string ProductId, decimal NewPrice, string Currency, string Reason) : IDomainEvent;
	...
	public sealed record CounterSnapshot(int Count, int Version);

	public sealed class CounterAggregate
	{
		private readonly List<IDomainEvent> _uncommittedEvents = [];
		public string Id { get; }
