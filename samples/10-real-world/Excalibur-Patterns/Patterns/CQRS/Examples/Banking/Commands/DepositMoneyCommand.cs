...
/// </summary>
public class DepositMoneyCommand : CommandBase
{
	/// <summary>
	///     Initializes a new instance of the <see cref="DepositMoneyCommand" /> class.
	/// </summary>
	public DepositMoneyCommand(string accountId, decimal amount, string? reference)
	{
		...
		AccountId = accountId;
		Amount = amount;
		Reference = reference ?? $"DEP-{Guid.NewGuid():N}";
	}
	...
	/// <summary>
	///     Gets the deposit Excalibur.Dispatch.Transport.Kafka.
	/// </summary>
