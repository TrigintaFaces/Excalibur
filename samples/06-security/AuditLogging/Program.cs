...
// Input validation accepts a user id that is either a GUID or 3-50 alphanumeric characters, so a
// hyphenated id is rejected and the dispatch throws before the handler runs.
context.SetItem("User:MessageId", "user12345");
