...
public class UserProfileAggregate : AggregateRoot<string>
{
	...
	private void Apply(UserCreatedV3 e)
	{
		Name = e.Name;
		Email = e.Email;
		Street = e.Street;
	...
	private void Apply(UserNameChangedV3 e)
	{
		Name = e.NewName;
	}

	private void Apply(UserAddressChangedV3 e)
	{
		Street = e.NewStreet;
		City = e.NewCity;
	...
	private void Apply(UserCreatedV1 e)
	{
		Name = e.Name;
		Email = e.Email;
		// No address in V1
	...
	private void Apply(UserCreatedV2 e)
	{
		Name = e.Name;
		Email = e.Email;
