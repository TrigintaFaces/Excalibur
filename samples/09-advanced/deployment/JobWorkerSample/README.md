...
This starts the worker with Quartz's in-memory job store — no database
required. All schedules, triggers, and execution history live for the
lifetime of the process.

### Swapping In A Persistent Job Store
