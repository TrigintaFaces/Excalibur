...
# ============================================================================
# CDC Job with Quartz.NET Sample - Insert Test Data
# ============================================================================
#
# This script inserts sample customer data into the LegacyCustomers table
# to generate CDC changes that will be processed by the CdcJob.
#
# Prerequisites:
...
echo "============================================================================"
echo ""
echo "The CdcJob should process these CDC changes on its next scheduled run:"
