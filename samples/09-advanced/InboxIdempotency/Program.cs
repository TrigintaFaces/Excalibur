...
Console.WriteLine("  services.AddExcaliburInbox(inbox => inbox.UseSqlServer(connectionString));");
Console.WriteLine("  services.AddExcaliburInbox(inbox => inbox.UsePostgres(connectionString));");
Console.WriteLine();
