...
```
WebApiQuickStart/
├── WebApiQuickStart.csproj    # Project file with Dispatch references
├── README.md                 # This file
...
- See `samples/01-getting-started/DispatchOnly` for a console-based example
- See `samples/01-getting-started/EventSourcingIntro` for full CQRS with event sourcing
