...
This sample shows how to build event-sourced aggregates using the Excalibur framework. It progresses from the pure Dispatch patterns shown in `DispatchOnly` to full domain modeling with aggregates, events, and repositories.

## Running the Sample

```bash
dotnet run --project samples/01-getting-started/EventSourcingIntro/EventSourcingIntro.csproj
```
...
## Comparison with DispatchOnly

| Concept | DispatchOnly | EventSourcingIntro |
|---------|-----------------|---------------|
