...
public class FindUserGrantsRequest : DataRequest<Dictionary<string, object>>
{
	public FindUserGrantsRequest(string userId, CancellationToken cancellationToken)
	{
		...
		Command = CreateCommand(CommandText, Parameters, commandTimeout: DbTimeouts.RegularTimeoutSeconds,
