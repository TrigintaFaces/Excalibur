...
/// </summary>
public class MatchingGrantsQuery : DataQuery<IEnumerable<Grant>>
{
	/// <summary>
	///     Initializes a new instance of the <see cref="MatchingGrantsQuery" /> class.
	/// </summary>
	...
	public MatchingGrantsQuery(string? userId, string tenantId, string grantType, string qualifier, CancellationToken cancellationToken)
	{
