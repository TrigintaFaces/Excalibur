# Dispatch Brand Assets

This folder contains all brand assets for the Dispatch .NET messaging framework, based on Concept 15 (three paper airplanes).

## Color Palette

- **Primary Cyan**: `#00d4ff` (main brand color)
- **Light Cyan**: `#5de4ff` (highlights)
- **Dark Purple**: `#7b68ee` (accent, optional)
...
| `favicon.svg`          | 32x32   | Favicon (simplified single plane)  |
...
3. Reference in README:
   ...
   ```markdown
   ![Dispatch Banner](./images/github-banner.png)
   ```
...
- Tight spacing between planes (matching wing gap)
- Paper airplane shape: two triangular wings + center line separator
- Left-pointing direction (message flow from right to left)

**Scale**:

- Full logos: 0.7 scale
- Icons: 0.8 scale
- Favicon: simplified single plane

**Typography**:

- Font: Arial, sans-serif (web-safe, clean, modern)
- Text: "DISPATCH" (bold, letter-spacing: 2-3px)
- Tagline: "FAST .NET MESSAGING" (lighter weight, letter-spacing: 3-4px)
