...
public interface IAggregateRepository<TAggregate, in TKey> where TAggregate : class, IAggregateRoot<TKey>
{
	...
	public Task<int> Delete(TAggregate aggregate, CancellationToken cancellationToken);
	...
	public Task<bool> Exists(TKey key, CancellationToken cancellationToken);
	...
	public Task<int> Save(TAggregate aggregate, CancellationToken cancellationToken);
}
