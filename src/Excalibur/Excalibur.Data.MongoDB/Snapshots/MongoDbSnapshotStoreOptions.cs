...
/// <summary>
/// Configuration options for the MongoDB snapshot store.
/// </summary>
public sealed class MongoDbSnapshotStoreOptions
{
	/// <summary>
	...
	/// <summary>
	/// Gets or sets the collection name for snapshot documents.
	/// </summary>
	[Required]
