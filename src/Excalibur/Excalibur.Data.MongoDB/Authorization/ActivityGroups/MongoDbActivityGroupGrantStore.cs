...
/// <summary>
/// MongoDB implementation of <see cref="IActivityGroupGrantStore"/>.
/// </summary>
/// <remarks>
/// Uses MongoDB.Driver with Filter.Builder for type-safe queries.
/// Implements upsert via ReplaceOneAsync with IsUpsert=true.
/// </remarks>
public sealed partial class MongoDbActivityGroupGrantStore : IActivityGroupGrantStore, IAsyncDisposable
{
	private readonly MongoDbAuthorizationOptions _options;
	private readonly ILogger<MongoDbActivityGroupGrantStore> _logger;
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MongoDbActivityGroupGrantStore"/> class.
	/// </summary>
	/// <param name="options">The MongoDB authorization options.</param>
	/// <param name="logger">The logger instance.</param>
	public MongoDbActivityGroupGrantStore(
		IOptions<MongoDbAuthorizationOptions> options,
		ILogger<MongoDbActivityGroupGrantStore> logger)
	{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MongoDbActivityGroupGrantStore"/> class with an existing client.
	/// </summary>
