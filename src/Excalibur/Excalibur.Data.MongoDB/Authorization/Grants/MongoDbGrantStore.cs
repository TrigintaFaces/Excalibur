...
/// <summary>
/// MongoDB implementation of <see cref="IGrantStore"/>.
/// </summary>
/// <remarks>
...
public sealed partial class MongoDbGrantStore : IGrantStore, IGrantQueryStore, IAsyncDisposable
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MongoDbGrantStore"/> class.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MongoDbGrantStore"/> class with an existing client.
	/// </summary>
