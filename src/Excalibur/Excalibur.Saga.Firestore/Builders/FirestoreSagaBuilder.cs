...
internal sealed class FirestoreSagaBuilder : IFirestoreSagaBuilder
{
	private readonly FirestoreSagaOptions _options;

	internal FirestoreSagaBuilder(FirestoreSagaOptions options)
	{
	...
	public IFirestoreSagaBuilder ProjectId(string projectId)
	{
	...
	public IFirestoreSagaBuilder CredentialsPath(string credentialsPath)
	{
	...
	public IFirestoreSagaBuilder CredentialsJson(string credentialsJson)
	{
	...
	public IFirestoreSagaBuilder EmulatorHost(string emulatorHost)
	{
	...
	public IFirestoreSagaBuilder Client(FirestoreDb client)
	{
	...
	public IFirestoreSagaBuilder ClientFactory(Func<IServiceProvider, FirestoreDb> clientFactory)
	{
	...
	public IFirestoreSagaBuilder BindConfiguration(string sectionPath)
	{
	...
	public IFirestoreSagaBuilder CollectionName(string collectionName)
	{
