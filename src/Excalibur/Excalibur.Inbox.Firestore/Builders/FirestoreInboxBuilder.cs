...
internal sealed class FirestoreInboxBuilder : IFirestoreInboxBuilder
{
	private readonly FirestoreInboxOptions _options;

	internal FirestoreInboxBuilder(FirestoreInboxOptions options)
	{
	...
	public IFirestoreInboxBuilder ProjectId(string projectId)
	{
	...
	public IFirestoreInboxBuilder CredentialsPath(string credentialsPath)
	{
	...
	public IFirestoreInboxBuilder CredentialsJson(string credentialsJson)
	{
	...
	public IFirestoreInboxBuilder EmulatorHost(string emulatorHost)
	{
	...
	public IFirestoreInboxBuilder Client(FirestoreDb client)
	{
	...
	public IFirestoreInboxBuilder ClientFactory(Func<IServiceProvider, FirestoreDb> clientFactory)
	{
	...
	public IFirestoreInboxBuilder BindConfiguration(string sectionPath)
	{
	...
	public IFirestoreInboxBuilder CollectionName(string collectionName)
	{
