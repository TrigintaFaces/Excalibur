...
internal sealed class FirestoreEventSourcingBuilder : IFirestoreEventSourcingBuilder
{
	private readonly FirestoreEventStoreOptions _options;

	internal FirestoreEventSourcingBuilder(FirestoreEventStoreOptions options)
	{
	...
	public IFirestoreEventSourcingBuilder ProjectId(string projectId)
	{
	...
	public IFirestoreEventSourcingBuilder CredentialsPath(string credentialsPath)
	{
	...
	public IFirestoreEventSourcingBuilder CredentialsJson(string credentialsJson)
	{
	...
	public IFirestoreEventSourcingBuilder EmulatorHost(string emulatorHost)
	{
		...
		// Clear credentials — emulator doesn't need them
		CredentialsPathValue = null;
		CredentialsJsonValue = null;
		_options.CredentialsPath = null;
		_options.CredentialsJson = null;
	...
	public IFirestoreEventSourcingBuilder Client(FirestoreDb client)
	{
	...
	public IFirestoreEventSourcingBuilder ClientFactory(Func<IServiceProvider, FirestoreDb> clientFactory)
	{
	...
	public IFirestoreEventSourcingBuilder BindConfiguration(string sectionPath)
	{
	...
	public IFirestoreEventSourcingBuilder CollectionName(string collectionName)
	{
		ArgumentException.ThrowIfNullOrWhiteSpace(collectionName);
		CollectionNameValue = collectionName;
		_options.EventsCollectionName = collectionName;
		return this;
	}
}
