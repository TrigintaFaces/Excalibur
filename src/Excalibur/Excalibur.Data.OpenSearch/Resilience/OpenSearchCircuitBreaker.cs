...
internal sealed class OpenSearchCircuitBreaker : IOpenSearchCircuitBreaker
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="OpenSearchCircuitBreaker" /> class.
	/// </summary>
	/// <param name="options"> The OpenSearch configuration options containing circuit breaker settings. </param>
	/// <param name="logger"> The logger for diagnostic information. </param>
	/// <exception cref="ArgumentNullException"> Thrown when any required parameter is null. </exception>
	public OpenSearchCircuitBreaker(
		IOptions<OpenSearchConfigurationOptions> options,
		ILogger<OpenSearchCircuitBreaker> logger)
	{
	...
	private void ThrowIfDisposed()
	{
		if (_disposed)
		{
			throw new ObjectDisposedException(nameof(OpenSearchCircuitBreaker));
		}
	}
}
