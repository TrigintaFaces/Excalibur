...
/// <summary>
/// Configuration options for <see cref="OpenSearchMaterializedViewStore"/>.
/// </summary>
public sealed class OpenSearchMaterializedViewStoreOptions
{
	/// <summary>
	...
	/// <summary>
	/// Gets or sets the OpenSearch node URI.
	/// </summary>
	...
	public OpenSearchAuthOptions Auth { get; set; } = new();
