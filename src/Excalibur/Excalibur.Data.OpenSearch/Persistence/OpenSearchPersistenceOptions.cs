...
/// <summary>
/// Configuration options for the OpenSearch persistence provider.
/// </summary>
public sealed class OpenSearchPersistenceOptions
{
    ...
    /// </summary>
    /// <value>
    /// The refresh policy. Defaults to <see cref="OpenSearchRefreshPolicy.WaitFor"/>.
    /// </value>
    public OpenSearchRefreshPolicy RefreshPolicy { get; set; } = OpenSearchRefreshPolicy.WaitFor;
