...
/// <summary>
/// Configures resilience patterns for OpenSearch operations including retries and circuit breakers.
/// </summary>
public sealed class OpenSearchResilienceOptions
{
	/// <summary>
	...
	public OpenSearchRetryPolicyOptions Retry { get; init; } = new();
	...
	public OpenSearchTimeoutOptions Timeouts { get; init; } = new();
}
