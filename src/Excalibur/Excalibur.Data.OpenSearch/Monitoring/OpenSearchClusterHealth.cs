...
/// <summary>
/// Represents comprehensive health information for an OpenSearch cluster.
/// </summary>
internal sealed class OpenSearchClusterHealth
{
	/// <summary>
	...
	/// <summary>
	/// Gets or sets the cluster health status string (green, yellow, red).
	/// </summary>
	/// <value>
	/// The cluster health status string.
	/// </value>
