...
/// <summary>
/// Provides comprehensive metrics collection for OpenSearch operations including performance, resilience, and health indicators.
/// </summary>
internal sealed class OpenSearchMetrics : IDisposable
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="OpenSearchMetrics" /> class.
	/// </summary>
	...
	public OpenSearchMetrics(string meterName = "Excalibur.Data.OpenSearch", string? version = null,
		double[]? durationHistogramBuckets = null)
	{
		...
		_operationDuration = _meter.CreateHistogram(
			"opensearch_operation_duration_ms",
			"ms",
			"Duration of OpenSearch operations in milliseconds",
	...
	public OpenSearchOperationContext StartOperation(string operationType, string? indexName = null)
	{
		ThrowIfDisposed();
		...
		return new OpenSearchOperationContext(this, operationType, indexName, tags);
	}
...
#pragma warning restore CA1308
	...
	/// <param name="healthStatus"> The detailed health status from OpenSearch. </param>
#pragma warning disable IDE0060 // Parameter kept for API parity with ElasticSearch counterpart
...
#pragma warning restore IDE0060
	...
	private static KeyValuePair<string, object?>[] CreateBaseTags(string operationType, string? indexName)
	{
		...
		{
			tags.Add(new KeyValuePair<string, object?>("opensearch.index.name", indexName));
		}
	...
	private void ThrowIfDisposed()
	{
		if (_disposed)
		{
			throw new ObjectDisposedException(nameof(OpenSearchMetrics));
		}
	}

	/// <summary>
	/// Represents the context of an OpenSearch operation for metrics tracking.
	/// </summary>
	/// <remarks>
	/// Nested type is intentionally not public as all monitoring types are internal.
	/// </remarks>
#pragma warning disable CA1034
	internal sealed class OpenSearchOperationContext : IDisposable
#pragma warning restore CA1034
	{
		private readonly OpenSearchMetrics _metrics;
		...
		internal OpenSearchOperationContext(
