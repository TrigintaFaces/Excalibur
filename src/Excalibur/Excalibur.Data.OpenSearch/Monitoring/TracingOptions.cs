...
/// <summary>
/// Configures distributed tracing integration for OpenSearch operations.
/// </summary>
internal sealed class TracingOptions
{
	...
	/// </summary>
	/// <value> A <see cref="string" /> representing the activity source identifier. Defaults to "Excalibur.Data.OpenSearch". </value>
	public string ActivitySourceName { get; init; } = "Excalibur.Data.OpenSearch";
}
