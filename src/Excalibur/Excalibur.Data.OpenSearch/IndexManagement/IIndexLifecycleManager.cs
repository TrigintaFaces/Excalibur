...
/// The ISM API is similar but the policy format differs. This interface provides an abstraction over ISM operations.
/// </remarks>
public interface IIndexLifecycleManager
{
	/// <summary>
	/// Creates an index state management (ISM) policy in OpenSearch.
	/// </summary>
	/// <param name="policyName"> The name of the ISM policy. </param>
	...
	/// <summary>
	/// Deletes an index state management (ISM) policy from OpenSearch.
	/// </summary>
	/// <param name="policyName"> The name of the ISM policy to delete. </param>
	/// <param name="cancellationToken"> The cancellation token to cancel the operation if required. </param>
	/// <returns> A <see cref="Task{Boolean}" /> indicating whether the operation was successful. </returns>
	...
	/// <summary>
	/// Gets the status of indices managed by ISM policies.
	/// </summary>
	...
	/// <summary>
	/// Forces an ISM policy to move to the next phase for specified indices.
	/// </summary>
