...
public interface IIndexAliasManager
{
	...
	Task<bool> CreateAliasAsync(string aliasName, IEnumerable<string> indexNames, CancellationToken cancellationToken);

	/// <summary>
	/// Deletes an alias from OpenSearch.
	/// </summary>
	...
	/// <summary>
	/// Checks if an alias exists in OpenSearch.
	/// </summary>
