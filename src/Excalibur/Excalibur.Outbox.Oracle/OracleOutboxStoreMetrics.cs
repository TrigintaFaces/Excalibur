...
/// <summary>
/// Provides metrics for Oracle outbox store operations.
/// </summary>
public sealed class OracleOutboxStoreMetrics : IDisposable
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="OracleOutboxStoreMetrics" /> class.
	/// </summary>
	public OracleOutboxStoreMetrics()
	{
		_meter = new Meter(OutboxOracleTelemetryConstants.MeterName, OutboxOracleTelemetryConstants.Version);
