...
/// <summary>
/// Represents a data request to insert a scheduled outbox message into the Oracle database.
/// </summary>
internal sealed class ScheduleOutboxMessage : DataRequest<int>
{
		...
		CancellationToken cancellationToken)
	{
		...
		var sql = $"""
			...
			VALUES
				(:MessageId, :MessageType, :MessageMetadata, :MessageBody, :TenantId, :Destination, SYSTIMESTAMP, 0, NULL, NULL, :ScheduledAt)
			""";
