...
public class ConcurrencyException : ConflictException
{
	...
	public ConcurrencyException()
		: base("A concurrency conflict occurred. The resource was modified by another process.")
	{
	}
	...
	public ConcurrencyException(string resource, string? resourceId, long expectedVersion, long actualVersion)
		: base(FormatConcurrencyMessage(resource, resourceId, expectedVersion, actualVersion))
	{
		Resource = resource;
