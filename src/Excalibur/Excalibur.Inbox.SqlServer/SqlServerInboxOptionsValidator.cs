...
internal sealed class SqlServerInboxOptionsValidator : IValidateOptions<SqlServerInboxOptions>
{
	public ValidateOptionsResult Validate(string? name, SqlServerInboxOptions options)
	{
		if (options is null)
		{
			return ValidateOptionsResult.Fail("SQL Server inbox options cannot be null.");
		}
