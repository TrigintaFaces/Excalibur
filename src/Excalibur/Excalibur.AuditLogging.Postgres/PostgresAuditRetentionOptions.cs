...
/// <summary>
/// Retention configuration options for the Postgres audit store.
/// </summary>
/// <remarks>
/// <para>
/// Mirrors <c>Excalibur.AuditLogging.SqlServer.SqlServerAuditRetentionOptions</c> property-for-property so a
/// retention configuration block written for one relational provider compiles unchanged against the other.
/// </para>
/// </remarks>
public sealed class PostgresAuditRetentionOptions
{
	/// <summary>
	...
	/// <summary>
	/// The shipped default for <see cref="CleanupBatchSize"/>. See <see cref="DefaultRetentionPeriod"/>.
	/// </summary>
	internal const int DefaultCleanupBatchSize = 10000;
	...
	/// onto, since each store's delete statement is dialect-specific. This is the Postgres store's own
