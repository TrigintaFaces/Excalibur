...
internal sealed class RedisInboxBuilder : IRedisInboxBuilder
{
	private readonly RedisInboxOptions _options;

	internal RedisInboxBuilder(RedisInboxOptions options)
	{
	...
	public IRedisInboxBuilder ConnectionString(string connectionString)
	{
	...
	public IRedisInboxBuilder ConnectionMultiplexer(IConnectionMultiplexer multiplexer)
	{
	...
	public IRedisInboxBuilder ConnectionMultiplexerFactory(Func<IServiceProvider, IConnectionMultiplexer> factory)
	{
	...
	public IRedisInboxBuilder BindConfiguration(string sectionPath)
	{
	...
	public IRedisInboxBuilder KeyPrefix(string prefix)
	{
	...
	public IRedisInboxBuilder Database(int database)
	{
