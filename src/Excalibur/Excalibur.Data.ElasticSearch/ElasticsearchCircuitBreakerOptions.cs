...
/// <summary>
/// Configures circuit breaker behavior for the Elasticsearch client, preventing cascading failures.
/// </summary>
/// <remarks>
/// Named for its provider rather than bare, because the framework also ships a circuit-breaker options
/// type for the dispatch pipeline. A consumer configuring both would otherwise hold two types of one name
/// in scope and have to disambiguate a collision the framework created.
/// </remarks>
public sealed class ElasticsearchCircuitBreakerOptions
{
	/// <summary>
	...
	/// <summary>
	/// Gets the failure-to-success ratio, from 0.0 to 1.0, at which the circuit opens.
	/// </summary>
	/// <value> A <see cref="double" /> representing the failure ratio. Defaults to 0.5 (50%). </value>
