...
internal sealed class OracleSagaStoreOptionsValidator : IValidateOptions<OracleSagaStoreOptions>
{
	public ValidateOptionsResult Validate(string? name, OracleSagaStoreOptions options)
	{
		if (options is null)
		{
			return ValidateOptionsResult.Fail("Oracle saga store options cannot be null.");
		}
