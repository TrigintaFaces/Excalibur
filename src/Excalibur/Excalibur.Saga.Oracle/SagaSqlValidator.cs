...
/// <summary>
/// Defense-in-depth SQL identifier validation for Oracle saga request types.
/// Validates that a qualified table name matches the expected unquoted <c>schema.table</c> format.
/// </summary>
