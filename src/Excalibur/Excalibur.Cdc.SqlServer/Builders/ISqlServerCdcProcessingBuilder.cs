...
/// <summary>
/// Defines the contract for configuring SQL Server CDC processing options including
/// schema, table naming, polling behavior, batch sizing, and command timeout.
/// </summary>
public interface ISqlServerCdcProcessingBuilder
{
	/// <summary>
