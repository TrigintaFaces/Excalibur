...
/// to an overflow sentinel. Prevents unbounded tag value growth (e.g., from dynamic instance
/// identifiers) that would cause O(n) metric scrape cost.
/// </summary>
/// <remarks>
/// <para>
...
internal sealed class TagCardinalityGuard
{
	...
	internal TagCardinalityGuard(int maxCardinality = 100, string overflowValue = "__other__")
	{
