...
/// <summary>
/// Configuration options for an individual Oracle snapshot store registration.
/// </summary>
/// <remarks>
/// Use this with <c>AddOracleSnapshotStore(Action&lt;OracleSnapshotStoreOptions&gt;)</c> for ergonomic
/// per-store configuration without needing a raw <c>Func&lt;OracleConnection&gt;</c>.
/// </remarks>
public sealed class OracleSnapshotStoreOptions
{
	/// <summary>
	...
	/// <summary>
	/// Gets or sets the schema name for the snapshot store table. Default: "EXCALIBUR".
	/// </summary>
