...
/// <summary>
/// Validates MongoDB outbox store configuration options.
/// </summary>
/// <remarks>
	...
	: IValidateOptions<MongoDbOutboxOptions>
{
	...
	public ValidateOptionsResult Validate(string? name, MongoDbOutboxOptions options)
	{
		...
		if (options.FailureBackoffFloorSeconds <= effectivePollSeconds)
		{
			...
			return ValidateOptionsResult.Fail(
				$"MongoDbOutboxOptions.FailureBackoffFloorSeconds ({options.FailureBackoffFloorSeconds}s) must be " +
