...
internal sealed class CosmosDbSagaBuilder : ICosmosDbSagaBuilder
{
	private readonly CosmosDbSagaOptions _options;

	internal CosmosDbSagaBuilder(CosmosDbSagaOptions options)
	{
	...
	public ICosmosDbSagaBuilder ConnectionString(string connectionString)
	{
	...
	public ICosmosDbSagaBuilder Endpoint(string endpoint, string authKey)
	{
	...
	public ICosmosDbSagaBuilder Client(CosmosClient client)
	{
	...
	public ICosmosDbSagaBuilder ClientFactory(Func<IServiceProvider, CosmosClient> clientFactory)
	{
	...
	public ICosmosDbSagaBuilder BindConfiguration(string sectionPath)
	{
	...
	public ICosmosDbSagaBuilder DatabaseName(string databaseName)
	{
	...
	public ICosmosDbSagaBuilder ContainerName(string containerName)
	{
