...
internal sealed class CosmosDbInboxBuilder : ICosmosDbInboxBuilder
{
	private readonly CosmosDbInboxOptions _options;

	internal CosmosDbInboxBuilder(CosmosDbInboxOptions options)
	{
	...
	public ICosmosDbInboxBuilder ConnectionString(string connectionString)
	{
	...
	public ICosmosDbInboxBuilder Endpoint(string endpoint, string authKey)
	{
	...
	public ICosmosDbInboxBuilder Client(CosmosClient client)
	{
	...
	public ICosmosDbInboxBuilder ClientFactory(Func<IServiceProvider, CosmosClient> clientFactory)
	{
	...
	public ICosmosDbInboxBuilder BindConfiguration(string sectionPath)
	{
	...
	public ICosmosDbInboxBuilder DatabaseName(string databaseName)
	{
	...
	public ICosmosDbInboxBuilder ContainerName(string containerName)
	{
