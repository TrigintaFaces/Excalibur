...
public interface IDataProcessorRegistry
{
	...
	bool TryGetFactory(string recordType, out Func<IServiceProvider, IDataProcessor> processor);
	...
	/// </exception>
	Func<IServiceProvider, IDataProcessor> GetFactory(string recordType);
}
