...
/// <summary>
/// Configuration options for the data processing background hosted service.
/// </summary>
/// <remarks>
/// <para>
/// These options control the polling behavior and lifecycle of
/// <c>DataProcessingHostedService</c>. They follow the same pattern
/// as <c>CdcProcessingOptions</c>.
/// </para>
/// <para>
/// These options are separate from <see cref="DataProcessingOptions"/>, which controls
/// queue sizes and batch sizes for individual processor pipelines.
/// </para>
/// </remarks>
public sealed class DataProcessingHostedServiceOptions
{
	/// <summary>
