...
/// <summary>
/// Implements <see cref="IDataProcessorDb" /> by delegating functionality to an underlying <see cref="IDb" /> instance.
/// </summary>
/// <remarks>
...
/// the <see cref="IDataProcessorDb" /> interface for use in data processing operations.
/// </remarks>
public sealed class DataProcessorDb : IDataProcessorDb
{
	private readonly IDb _db;

	/// <summary>
	/// Initializes a new instance of the <see cref="DataProcessorDb" /> class with the specified database instance.
	/// </summary>
