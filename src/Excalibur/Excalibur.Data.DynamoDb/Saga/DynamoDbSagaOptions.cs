...
/// <summary>
/// Configuration options for the DynamoDB saga store.
/// </summary>
public sealed class DynamoDbSagaOptions
{
	/// <summary>
	...
	/// <summary>
	/// Gets or sets the table name for sagas.
	/// </summary>
	...
	/// <summary>
	/// Gets or sets the default TTL in seconds for sagas.
	/// </summary>
	/// <remarks>
	/// Set to 0 for no expiration. When set, completed sagas will be automatically
