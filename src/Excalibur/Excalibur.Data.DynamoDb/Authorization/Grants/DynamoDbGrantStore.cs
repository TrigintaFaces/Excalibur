...
/// <summary>
/// DynamoDB implementation of <see cref="IGrantStore"/>.
/// </summary>
/// <remarks>
/// <para>
...
public sealed partial class DynamoDbGrantStore : IGrantStore, IGrantQueryStore, IAsyncDisposable, IDisposable
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="DynamoDbGrantStore"/> class.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="DynamoDbGrantStore"/> class with an existing client.
	/// </summary>
