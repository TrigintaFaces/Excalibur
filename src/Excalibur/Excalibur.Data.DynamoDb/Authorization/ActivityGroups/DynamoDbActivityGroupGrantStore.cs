...
/// <summary>
/// DynamoDB implementation of <see cref="IActivityGroupGrantStore"/>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public sealed partial class DynamoDbActivityGroupGrantStore : IActivityGroupGrantStore, IAsyncDisposable, IDisposable
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="DynamoDbActivityGroupGrantStore"/> class.
	/// </summary>
	/// <param name="options">The DynamoDB authorization options.</param>
	/// <param name="logger">The logger instance.</param>
	public DynamoDbActivityGroupGrantStore(
		IOptions<DynamoDbAuthorizationOptions> options,
		ILogger<DynamoDbActivityGroupGrantStore> logger)
	{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="DynamoDbActivityGroupGrantStore"/> class with an existing client.
	/// </summary>
