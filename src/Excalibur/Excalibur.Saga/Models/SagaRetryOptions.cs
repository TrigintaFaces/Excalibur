...
/// </summary>
public sealed class SagaRetryOptions
{
	/// <summary>
	...
	public static SagaRetryOptions ExponentialBackoff(int maxAttempts = 3, TimeSpan? initialDelay = null) =>
		new()
		{
	...
	/// <returns> A new retry policy. </returns>
	public static SagaRetryOptions FixedDelay(int maxAttempts = 3, TimeSpan? delay = null) =>
