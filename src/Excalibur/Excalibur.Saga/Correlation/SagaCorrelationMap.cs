...
/// <summary>
/// Immutable options for saga correlation rules compiled from <see cref="ISagaCorrelationBuilder{TSaga}"/>.
/// </summary>
...
/// </para>
/// </remarks>
public sealed class SagaCorrelationMap<TSaga>
	where TSaga : class
{
	private readonly IReadOnlyDictionary<Type, Func<object, string>> _correlators;

	/// <summary>
	/// Initializes a new instance of the <see cref="SagaCorrelationMap{TSaga}"/> class.
	/// </summary>
	/// <param name="correlators">The compiled correlation functions keyed by message type.</param>
	internal SagaCorrelationMap(IReadOnlyDictionary<Type, Func<object, string>> correlators)
	{
