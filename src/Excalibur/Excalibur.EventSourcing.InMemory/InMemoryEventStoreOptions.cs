...
/// <summary>
/// Configuration options for the in-memory event store.
/// </summary>
public sealed class InMemoryEventStoreOptions
{
	...
	/// <see cref="IJsonTypeInfoResolver"/>) covering those types to remove that dependency.
	/// </para>
	/// <para>
	...
	///     options =&gt; options.EventTypeInfoResolver = AppEventContext.Default);
	/// </code>
	/// </example>
