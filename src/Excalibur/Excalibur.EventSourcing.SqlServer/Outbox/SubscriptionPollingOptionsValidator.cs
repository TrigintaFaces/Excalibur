...
internal sealed class SubscriptionPollingOptionsValidator : IValidateOptions<SubscriptionPollingOptions>
{
	public ValidateOptionsResult Validate(string? name, SubscriptionPollingOptions options)
	{
		if (options is null)
		{
			return ValidateOptionsResult.Fail("Subscription polling options cannot be null.");
		}
