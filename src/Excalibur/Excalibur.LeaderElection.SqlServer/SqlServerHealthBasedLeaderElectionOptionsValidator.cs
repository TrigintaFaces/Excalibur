...
/// <summary>
/// Validates <see cref="SqlServerHealthBasedLeaderElectionOptions"/> at startup (AOT-safe, reflection-free).
/// </summary>
internal sealed class SqlServerHealthBasedLeaderElectionOptionsValidator
	: IValidateOptions<SqlServerHealthBasedLeaderElectionOptions>
{
	public ValidateOptionsResult Validate(string? name, SqlServerHealthBasedLeaderElectionOptions options)
	{
