...
internal sealed class CosmosDbOutboxBuilder : ICosmosDbOutboxBuilder
{
	private readonly CosmosDbOutboxOptions _options;

	internal CosmosDbOutboxBuilder(CosmosDbOutboxOptions options)
	{
	...
	public ICosmosDbOutboxBuilder ConnectionString(string connectionString)
	{
	...
	public ICosmosDbOutboxBuilder Endpoint(string endpoint, string authKey)
	{
	...
	public ICosmosDbOutboxBuilder Client(CosmosClient client)
	{
	...
	public ICosmosDbOutboxBuilder ClientFactory(Func<IServiceProvider, CosmosClient> clientFactory)
	{
	...
	public ICosmosDbOutboxBuilder BindConfiguration(string sectionPath)
	{
	...
	public ICosmosDbOutboxBuilder DatabaseName(string databaseName)
	{
	...
	public ICosmosDbOutboxBuilder ContainerName(string containerName)
	{
