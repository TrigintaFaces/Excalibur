...
/// <summary>
/// Hosted service that runs Postgres schema migrations on application startup.
/// </summary>
/// <remarks>
/// <para>
/// This service is automatically registered when <see cref="PostgresMigratorOptions.AutoMigrateOnStartup"/>
...
public sealed partial class PostgresMigrationHostedService(
	IMigrator migrator,
	ILogger<PostgresMigrationHostedService> logger) : IHostedService
{
	...
	private readonly ILogger<PostgresMigrationHostedService> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
