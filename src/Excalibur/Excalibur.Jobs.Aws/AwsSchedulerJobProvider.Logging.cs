...
using Excalibur.Jobs.Aws.Diagnostics;
...
public partial class AwsSchedulerJobProvider
{
	...
	[LoggerMessage(AwsJobsEventId.AwsSchedulerScheduleCreated, LogLevel.Information,
	...
	[LoggerMessage(AwsJobsEventId.AwsSchedulerScheduleCreationFailed, LogLevel.Error,
	...
	[LoggerMessage(AwsJobsEventId.AwsSchedulerScheduleDeleted, LogLevel.Information,
		"Successfully deleted AWS EventBridge schedule {JobName}")]
	private partial void LogDeletedScheduleSuccess(string jobName);

	[LoggerMessage(AwsJobsEventId.AwsSchedulerScheduleNotFound, LogLevel.Warning,
	...
	[LoggerMessage(AwsJobsEventId.AwsSchedulerScheduleDeletionFailed, LogLevel.Error,
