...
internal sealed class FirestoreOutboxBuilder : IFirestoreOutboxBuilder
{
	private readonly FirestoreOutboxOptions _options;

	internal FirestoreOutboxBuilder(FirestoreOutboxOptions options)
	{
	...
	public IFirestoreOutboxBuilder ProjectId(string projectId)
	{
	...
	public IFirestoreOutboxBuilder CredentialsPath(string credentialsPath)
	{
	...
	public IFirestoreOutboxBuilder CredentialsJson(string credentialsJson)
	{
	...
	public IFirestoreOutboxBuilder EmulatorHost(string emulatorHost)
	{
	...
	public IFirestoreOutboxBuilder Client(FirestoreDb client)
	{
	...
	public IFirestoreOutboxBuilder ClientFactory(Func<IServiceProvider, FirestoreDb> clientFactory)
	{
	...
	public IFirestoreOutboxBuilder BindConfiguration(string sectionPath)
	{
	...
	public IFirestoreOutboxBuilder CollectionName(string collectionName)
	{
