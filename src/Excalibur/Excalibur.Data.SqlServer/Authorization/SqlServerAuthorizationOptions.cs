...
/// <summary>
/// Configures where the SqlServer activity-group store keeps its table.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public sealed class SqlServerAuthorizationOptions
{
	/// <summary>
	/// Gets or sets the schema that holds the <c>ActivityGroup</c> table.
	/// </summary>
	/// <value>
