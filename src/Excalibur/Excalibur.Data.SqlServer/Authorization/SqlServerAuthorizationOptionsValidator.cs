...
/// </summary>
internal sealed class SqlServerAuthorizationOptionsValidator : IValidateOptions<SqlServerAuthorizationOptions>
{
	/// <inheritdoc/>
	public ValidateOptionsResult Validate(string? name, SqlServerAuthorizationOptions options)
	{
