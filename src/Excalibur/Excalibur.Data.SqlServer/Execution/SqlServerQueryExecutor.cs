...
/// <summary>
/// Initializes a new instance of the <see cref="SqlServerQueryExecutor" /> class.
/// </summary>
/// <param name="connectionFactory"> </param>
public sealed class SqlServerQueryExecutor(Func<IDbConnection> connectionFactory) : IQueryExecutor
{
