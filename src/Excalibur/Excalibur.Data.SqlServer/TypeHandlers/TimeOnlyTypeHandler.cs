...
/// </summary>
/// <remarks> Initializes a new instance of the <see cref="TimeOnlyTypeHandler" /> class. </remarks>
...
/// </param>
public sealed class TimeOnlyTypeHandler(IFormatProvider? formatProvider = null) : SqlMapper.TypeHandler<TimeOnly>
{
