...
public interface IDataChangeHandler
{
	...
	/// </summary>
	/// <value>
	/// The names of the tables that this handler is responsible for processing.
	/// </value>
	/// <remarks>
	...
	/// </exception>
	Task HandleAsync(DataChangeEvent changeEvent, CancellationToken cancellationToken);
}
