...
public sealed class DataChangeEvent
{
	...
	/// </summary>
	/// <value>
	/// The log sequence number (LSN) associated with the change event.
	/// </value>
	...
	/// </summary>
	/// <value>
	/// The log sequence value associated with the change event.
	/// </value>
	...
	/// </summary>
	/// <value>
	/// The type of the data change (e.g., Insert, Update, Delete).
	/// </value>
	...
	/// </summary>
	/// <value>
	/// The collection of individual data changes for the affected table row.
	/// </value>
