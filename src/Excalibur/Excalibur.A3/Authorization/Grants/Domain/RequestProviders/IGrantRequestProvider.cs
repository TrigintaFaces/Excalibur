...
public interface IGrantRequestProvider
{
	...
	IDataRequest<IDbConnection, int> DeleteGrant(string userId, string tenantId, string grantType, string qualifier,
		string? revokedBy,
	...
	IDataRequest<IDbConnection, bool> GrantExists(string userId, string tenantId, string grantType, string qualifier,
	...
	IDataRequest<IDbConnection, IEnumerable<Grant>> GetMatchingGrants(string? userId, string tenantId, string grantType,
		string qualifier,
		CancellationToken cancellationToken);
	...
	IDataRequest<IDbConnection, Grant?> GetGrant(string userId, string tenantId, string grantType, string qualifier,
		CancellationToken cancellationToken);
	...
	IDataRequest<IDbConnection, IEnumerable<Grant>> GetAllGrants(string userId, CancellationToken cancellationToken);
	...
	IDataRequest<IDbConnection, int> SaveGrant(Grant grant, CancellationToken cancellationToken);
	...
	IDataRequest<IDbConnection, Dictionary<string, object>> FindUserGrants(string userId, CancellationToken cancellationToken);
	...
	IDataRequest<IDbConnection, int> DeleteAllActivityGroupGrants(string grantType, CancellationToken cancellationToken);
	...
	IDataRequest<IDbConnection, IEnumerable<string>> GetDistinctActivityGroupGrantUserIds(
		string grantType,
		CancellationToken cancellationToken);
}
