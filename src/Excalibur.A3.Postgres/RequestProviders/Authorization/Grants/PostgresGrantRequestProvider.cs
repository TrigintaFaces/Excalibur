...
/// <summary>
///     A query provider for PostgreSQL databases, implementing the <see cref="IGrantRequestProvider" /> interface.
/// </summary>
public class PostgresGrantRequestProvider : IGrantRequestProvider
{
	/// <inheritdoc />
