...
{
	/// <summary>
	/// Initializes a new instance of the <see cref="HistogramOptions" /> class with the specified bucket boundaries. Bucket
	...
	public HistogramOptions(params double[] buckets)
	{
		if (buckets == null || buckets.Length == 0)
		{
			throw new ArgumentException(Resources.HistogramOptions_AtLeastOneBucketBoundaryIsRequired, nameof(buckets));
		}
	...
	/// </value>
	public static HistogramOptions DefaultLatency => new(
	...
	/// </value>
	public static HistogramOptions DefaultSize => Exponential(100, 2, 10);
	...
	public static HistogramOptions Exponential(double start, double factor, int count)
	{
		if (start <= 0)
		{
			throw new ArgumentException(Resources.HistogramOptions_StartMustBePositive, nameof(start));
		}

		if (factor <= 1)
		{
			throw new ArgumentException(Resources.HistogramOptions_FactorMustBeGreaterThanOne, nameof(factor));
		}

		if (count <= 0)
		{
			throw new ArgumentException(Resources.HistogramOptions_CountMustBePositive, nameof(count));
		}
		...
		return new HistogramOptions(buckets);
	}
	...
	/// </summary>
	/// <exception cref="ArgumentException"></exception>
	public static HistogramOptions Linear(double start, double width, int count)
	{
		if (width <= 0)
		{
			throw new ArgumentException(Resources.HistogramOptions_WidthMustBePositive, nameof(width));
		}
