...
/// <summary>
/// Non-generic view over a registered <c>ICloudEventEncoder&lt;TOutbound&gt;</c> that lets
...
/// </summary>
public interface ICloudEventEncoderAdapter
{
	/// <summary>
	/// Gets the transport-message type this adapter encodes to.
	/// </summary>
