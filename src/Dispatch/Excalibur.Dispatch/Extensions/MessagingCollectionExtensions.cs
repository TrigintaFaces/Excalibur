...
namespace Excalibur.Dispatch.Messaging.Extensions;
...
public static class MessagingCollectionExtensions
{
	...
	/// </remarks>
	// R0.8: Do not expose generic lists
...
#pragma warning restore CA1002 // Do not expose generic lists
	{
		...
		return source switch
		{
			...
			// Pre-allocate capacity for arrays
			T[] array => [.. array],

			// Pre-allocate capacity for collections with known count
	...
	/// <exception cref="ArgumentNullException"> Thrown when source is null. </exception>
	/// <remarks> If the source is already a ReadOnlyCollection, it returns a new instance to ensure immutability. </remarks>
	...
	/// <exception cref="ArgumentNullException"> Thrown when source is null. </exception>
	/// <remarks> This method creates a copy even if the source is already an array to prevent external modifications. </remarks>
