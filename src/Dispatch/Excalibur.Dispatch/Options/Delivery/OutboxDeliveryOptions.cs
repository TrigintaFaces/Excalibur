...
/// </code>
/// </remarks>
public class OutboxDeliveryOptions
{
	...
	/// </summary>
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance configured for high throughput.</returns>
	/// <remarks>
	/// <para>Settings:</para>
	/// <list type="bullet">
	...
	/// </remarks>
	public static OutboxDeliveryOptions HighThroughput() => new()
	{
		PerRunTotal = 10000,
		QueueCapacity = 10000,
	...
	/// </summary>
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance with balanced settings.</returns>
	/// <remarks>
	/// <para>Settings:</para>
	/// <list type="bullet">
	...
	/// </remarks>
	public static OutboxDeliveryOptions Balanced() => new()
	{
		PerRunTotal = 1000,
		QueueCapacity = 1000,
	...
	/// </summary>
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance configured for high reliability.</returns>
	/// <remarks>
	/// <para>Settings:</para>
	/// <list type="bullet">
	...
	/// </remarks>
	public static OutboxDeliveryOptions HighReliability() => new()
	{
		PerRunTotal = 100,
		QueueCapacity = 100,
	...
	/// </param>
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance with the updated batch sizes.</returns>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <code>
	/// var options = OutboxDeliveryOptions.HighThroughput().WithBatchSize(500);
	/// </code>
	/// </remarks>
	public OutboxDeliveryOptions WithBatchSize(int producerBatchSize, int? consumerBatchSize = null)
	{
		var clone = Clone();
	...
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance with the updated parallelism.</returns>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <code>
	/// var options = OutboxDeliveryOptions.HighThroughput().WithParallelDegree(4);
	/// </code>
	/// </remarks>
	public OutboxDeliveryOptions WithParallelDegree(int degree)
	{
		var clone = Clone();
	...
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance with the updated guarantee.</returns>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <code>
	/// var options = OutboxDeliveryOptions.Balanced().WithDeliveryGuarantee(OutboxDeliveryGuarantee.MinimizedWindow);
	/// </code>
	/// </remarks>
	public OutboxDeliveryOptions WithDeliveryGuarantee(OutboxDeliveryGuarantee guarantee)
	{
		var clone = Clone();
	...
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance with the updated retry count.</returns>
	/// <remarks>
	/// <para>
	...
	/// </code>
	/// </remarks>
	public OutboxDeliveryOptions WithMaxAttempts(int maxAttempts)
	{
		var clone = Clone();
	...
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance with the updated timeout.</returns>
	/// <remarks>
	/// <para>
	...
	/// </code>
	/// </remarks>
	public OutboxDeliveryOptions WithTimeout(TimeSpan timeout)
	{
		var clone = Clone();
	...
	/// </summary>
	/// <returns>A new <see cref="OutboxDeliveryOptions"/> instance with cloned property values.</returns>
	...
	public static string? Validate(OutboxDeliveryOptions options)
	{
