...
public sealed class AzureStorageQueueOptions
{
	...
	/// <summary>
	/// Gets or sets the polling and batching options for queue message retrieval.
	/// </summary>
	/// <value>
	/// The polling and batching options.
	/// </value>
	public StorageQueuePollingOptions Polling { get; set; } = new();
...
/// <summary>
/// Polling and batching options for Azure Storage Queue message retrieval.
/// </summary>
public sealed class StorageQueuePollingOptions
{
	/// <summary>
