...
public interface IMessageProblemDetails
{
	...
	/// </summary>
	/// <remarks>
	/// This is only advisory; the actual HTTP status code is determined by the server. When used outside of HTTP contexts,
	/// this value indicates the closest equivalent HTTP status code for the problem.
	/// </remarks>
	/// <value> The HTTP status code when available; otherwise, <see langword="null" />. </value>
	int? Status { get; set; }
