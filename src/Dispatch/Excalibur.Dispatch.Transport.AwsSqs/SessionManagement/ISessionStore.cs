...
public interface ISessionStore
{
	...
	[RequiresUnreferencedCode("Session serialization may require unreferenced types")]
	[RequiresDynamicCode("Session serialization may use dynamic code generation")]
	...
	/// </summary>
	/// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
	[RequiresUnreferencedCode("Session deserialization may require unreferenced types")]
	[RequiresDynamicCode("Session deserialization may use dynamic code generation")]
