...
public sealed record InputValidationResult(bool IsValid, string[] Errors)
{
	/// <summary>
	...
	/// <returns> A failed validation result with the specified errors. </returns>
	public static InputValidationResult Failure(params string[] errors) => new(false, errors);
}
