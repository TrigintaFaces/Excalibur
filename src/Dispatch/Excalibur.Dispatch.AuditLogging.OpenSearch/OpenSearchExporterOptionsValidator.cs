...
/// <summary>
/// Validates <see cref="OpenSearchExporterOptions"/> cross-property constraints.
/// </summary>
internal sealed class OpenSearchExporterOptionsValidator : IValidateOptions<OpenSearchExporterOptions>
{
    public ValidateOptionsResult Validate(string? name, OpenSearchExporterOptions options)
    {
