...
/// <summary>
/// Configuration options for the Elasticsearch audit sink.
/// </summary>
/// <remarks>
/// <para>
/// The audit sink writes individual audit events to Elasticsearch in real-time
...
/// use <see cref="ElasticsearchUrl"/> instead.
/// </para>
/// </remarks>
public sealed class ElasticsearchAuditSinkOptions
{
	/// <summary>
	/// Gets or sets the Elasticsearch node URLs for cluster connectivity.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <para>
	/// Example: ["https://es-node1:9200", "https://es-node2:9200", "https://es-node3:9200"]
	/// </para>
	/// </remarks>
	public List<string>? NodeUrls { get; set; }

	/// <summary>
	/// Gets or sets the Elasticsearch base URL (single-node convenience).
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// in Kibana dashboards and ES queries.
	/// </para>
	/// </remarks>
	...
	/// <summary>
	/// Gets the resolved node URLs, preferring <see cref="NodeUrls"/> over <see cref="ElasticsearchUrl"/>.
	/// </summary>
