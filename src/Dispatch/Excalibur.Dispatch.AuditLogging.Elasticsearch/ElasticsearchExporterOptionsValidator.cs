...
/// <summary>
/// Validates <see cref="ElasticsearchExporterOptions"/> cross-property constraints.
/// </summary>
internal sealed class ElasticsearchExporterOptionsValidator : IValidateOptions<ElasticsearchExporterOptions>
{
	public ValidateOptionsResult Validate(string? name, ElasticsearchExporterOptions options)
	{
