...
public sealed class RabbitMqRetryOptions
{
	...
	public int MaxRetryAttempts { get; private init; }
	...
	public static RabbitMqRetryOptions None() => new()
	{
		MaxRetryAttempts = 0,
	...
	public static RabbitMqRetryOptions Fixed(int maxRetries, TimeSpan? delay = null) => new()
	{
	...
	public static RabbitMqRetryOptions Exponential(
		int maxRetries,
