...
/// </summary>
public class DeleteGrantQuery : DataQuery<int>
{
	/// <summary>
	///     Initializes a new instance of the <see cref="DeleteGrantQuery" /> class.
	/// </summary>
	...
	public DeleteGrantQuery(string userId, string tenantId, string grantType, string qualifier, string? revokedBy,
